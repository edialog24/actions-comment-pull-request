...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const new_comment = octokit.issues.createComment(Object.assign(Object.assign({}, context.repo), { issue_number: pull_request_number, body: message + " and " + pull_request_reviewers }));
